...
StartPoint=35;EndPoint=8;
[Min_Distance Path]=ShortestPath_Djk(CostA,CrossPointNo,StartPoint);
%调用PrintPath来显示各点与起始点之间的最短路的路径
%其中，a,b为ShortestPath_Djk()的返回值
  PrintPath(Min_Distance,Path,StartPoint,EndPoint);
  fprintf('路径长度:%f',Min_Distance(EndPoint));
  fprintf('\n');
